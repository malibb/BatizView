                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 spacing">
                        ...
                        <div class="spacingmini">
                            <p class="sig">¿Eres profesor? <a href="../Profesor/registroP.jsp">Ingresa Aqui</a></p>
                            <p class="sig">¿Ya tienes cuenta en BatizView? <a href="../public/InicioSesion.jsp">Ingresa aqui</a></p>
                        </div>
                        <p class="<%=error%>"><%=men%></p>

                        <form class="signupR" action="../../rAlumno" method="post">
                            <fieldset class="fs">
                                <div class=" ">
                                ...
                                <div class=" ">
                                    <div class="field-wrapper">
                                        <label for="identificador">Boleta</label>
                                        <input type="number" name="identificador" id="identificador" autocomplete="off" required>
                                        <div class="field-help below21">Tu numero de boleta dentro del Cecyt 9</div>
                                    </div>
                                </div>
                                <div class=" ">
                                    <div class="field-wrapper">
