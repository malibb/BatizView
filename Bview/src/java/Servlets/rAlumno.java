...
public class rAlumno extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bool.add(vos.isId(datosUQ.get(0).toString()));
            ...
            qs.setSql("INSERT INTO cuenta(id_cue, tip_cue, edo_cue, pas_cue, ema_cue, Persona_id_per) values(?,2,0,?,?," + datosRe.get(0) + ");");
